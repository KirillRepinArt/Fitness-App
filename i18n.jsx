...
const STRINGS = {
  en: {
    ...
    'today.addExercise': 'Add exercise', 'today.restoreDefault': 'Restore default',
    'today.dayModified': 'Modified',
    'meso.title': 'Mesocycle', 'meso.label': 'MESO',
    'meso.programDay': 'Day {n} of program', 'meso.suggested': 'Suggested',
    'meso.deloadRound': 'Deload round', 'meso.restDay': 'Rest day',
    'meso.legend.work': 'Workout', 'meso.legend.rest': 'Rest',
    'meso.legend.done': 'Done', 'meso.legend.deload': 'Deload',
    'meso.collapse': 'Collapse', 'meso.expand': 'Expand',
    'picker.title': 'Add exercise', 'picker.sub': 'Tap to add with default sets',
    'picker.search': 'Search…', 'picker.cancel': 'Cancel', 'picker.empty': 'No matches',
    'picker.alreadyIn': 'In today',
    // Program
    ...
    'cat.title': 'Catalogue', 'cat.sub': 'PROGRAMS', 'cat.builtin': 'DEFAULT', 'cat.custom': 'MY PROGRAMS',
    'cat.builtinTitle': 'Default — built-in templates',
    'cat.customTitle': 'My programs',
    ...
    'cat.deploy': 'Deploy', 'cat.deployed': 'Deployed', 'cat.runsCount': 'runs',
    'cat.deployConfirm.title': 'Replace active program?',
    'cat.deployConfirm.body': 'Your current run will be archived. A fresh "{name} · #{n}" will become Active.',
    'cat.deployConfirm.bodyNoActive': 'A fresh "{name} · #{n}" will start as your Active program.',
    'cat.deployConfirm.ok': 'Deploy', 'cat.deployConfirm.cancel': 'Cancel',
    'cat.stats': 'Statistics', 'cat.runOf': 'Run #{n}', 'cat.openStats': 'Open stats',
    'cat.editComing': 'Editing coming soon', 'cat.readOnlyNote': 'Default templates open as copies when edited',
  ...
  ru: {
    ...
    'today.addExercise': 'Добавить упражнение', 'today.restoreDefault': 'Сбросить порядок',
    'today.dayModified': 'Изменено',
    'meso.title': 'Мезоцикл', 'meso.label': 'МЕЗО',
    'meso.programDay': 'День {n} программы', 'meso.suggested': 'По плану',
    'meso.deloadRound': 'Разгрузочный цикл', 'meso.restDay': 'День отдыха',
    'meso.legend.work': 'Тренировка', 'meso.legend.rest': 'Отдых',
    'meso.legend.done': 'Сделано', 'meso.legend.deload': 'Разгрузка',
    'meso.collapse': 'Свернуть', 'meso.expand': 'Развернуть',
    'picker.title': 'Добавить упражнение', 'picker.sub': 'Нажмите, чтобы добавить с базовыми подходами',
    'picker.search': 'Поиск…', 'picker.cancel': 'Отмена', 'picker.empty': 'Ничего не найдено',
    'picker.alreadyIn': 'Уже в дне',
    ...
    'cat.title': 'Каталог', 'cat.sub': 'ПРОГРАММЫ', 'cat.builtin': 'ПО УМОЛЧАНИЮ', 'cat.custom': 'МОИ ПРОГРАММЫ',
    'cat.builtinTitle': 'Базовые шаблоны',
    'cat.customTitle': 'Мои программы',
    ...
    'cat.deploy': 'Развернуть', 'cat.deployed': 'Развёрнута', 'cat.runsCount': 'зап.',
    'cat.deployConfirm.title': 'Заменить активную программу?',
    'cat.deployConfirm.body': 'Текущий запуск будет архивирован. Свежий «{name} · #{n}» станет активным.',
    'cat.deployConfirm.bodyNoActive': 'Свежий «{name} · #{n}» станет активным.',
    'cat.deployConfirm.ok': 'Развернуть', 'cat.deployConfirm.cancel': 'Отмена',
    'cat.stats': 'Статистика', 'cat.runOf': 'Запуск #{n}', 'cat.openStats': 'Открыть статистику',
    'cat.editComing': 'Редактор в разработке', 'cat.readOnlyNote': 'Базовые шаблоны откроются как копия при редактировании',
  ...
  zh: {
    ...
    'today.finish.cta': '完成',
    'today.addExercise': '添加动作', 'today.restoreDefault': '恢复默认',
    'today.dayModified': '已修改',
    'meso.title': '中周期', 'meso.label': '中周期',
    'meso.programDay': '计划第 {n} 日', 'meso.suggested': '预计',
    'meso.deloadRound': '减载周期', 'meso.restDay': '休息日',
    'meso.legend.work': '训练', 'meso.legend.rest': '休息',
    'meso.legend.done': '已完成', 'meso.legend.deload': '减载',
    'meso.collapse': '折叠', 'meso.expand': '展开',
    'picker.title': '添加动作', 'picker.sub': '点击添加默认组数',
    'picker.search': '搜索…', 'picker.cancel': '取消', 'picker.empty': '无匹配',
    'picker.alreadyIn': '已在今日',
    ...
    'cat.title': '计划库', 'cat.sub': '计划', 'cat.builtin': '默认', 'cat.custom': '我的计划',
    'cat.builtinTitle': '默认 — 内置模板',
    'cat.customTitle': '我的计划',
    ...
    'cat.deploy': '部署', 'cat.deployed': '已部署', 'cat.runsCount': '次',
    'cat.deployConfirm.title': '替换当前计划?',
    'cat.deployConfirm.body': '当前运行将被存档。新的「{name} · #{n}」将开始。',
    'cat.deployConfirm.bodyNoActive': '新的「{name} · #{n}」将作为你的当前计划开始。',
    'cat.deployConfirm.ok': '部署', 'cat.deployConfirm.cancel': '取消',
    'cat.stats': '统计', 'cat.runOf': '运行 #{n}', 'cat.openStats': '打开统计',
    'cat.editComing': '编辑功能即将推出', 'cat.readOnlyNote': '默认模板编辑时会先复制',
